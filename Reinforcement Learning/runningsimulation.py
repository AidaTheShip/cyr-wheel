...
def train():
    ...
    eval_callback = EvalCallback(
        env, 
        eval_freq=100, # how often to perform evaluation i.e. every 10000 timesteps.
    ...
    """
    model.learn(total_timesteps=int(100), tb_log_name=f"{args.gymenv}_{args.sb3_algo}", callback=eval_callback)
